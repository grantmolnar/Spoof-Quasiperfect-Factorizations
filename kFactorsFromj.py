...
#This is the file where our j factor candidateslive
...
checkedThrough = "checkedFrom" + startFromHere + ".txt"
...
#We work our way forwards from startingIndex to the end of our list of possibilities
for i in range(startingIndex,length):
    spoof = partialFactorsArray[i].tolist()
